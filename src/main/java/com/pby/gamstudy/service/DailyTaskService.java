...
public class DailyTaskService {
    ...
    private static final String DAILY_CARD_COMMIT_SUFFIX = "daily_card_commit_suffix";
    ...
    public List<DailyTask> findDailyTask(String userId) {
        ...
        dailyTaskList.add(new DailyTask(mRedisManager.get(userId + DAILY_SIGN_SUFFIX) != null, null, 0));
        dailyTaskList.add(new DailyTask(mRedisManager.get(userId + DAILY_CARD_COMMIT_SUFFIX) != null, dailyCardList, dailyCardCount));
    ...
    public boolean sign(String userId) {
        ...
        return userDao.increaseScore(userId, 5) == 1;
    }

    public boolean commitDailyTask(String userId) {
        mRedisManager.set(userId + DAILY_CARD_COMMIT_SUFFIX, true, TimeUtil.getOffsetTimeForNextDay(), TimeUnit.MILLISECONDS);
        return userDao.increaseScore(userId, 20) == 1;
    }
